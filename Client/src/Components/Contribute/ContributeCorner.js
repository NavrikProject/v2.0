              ...
              <ContributeContentFlex>
                <ContributeContentLeft>
                  <ContributeContentDesc>
                    ...
                    out more.<ContactLink href="#form">Contact Us</ContactLink>
                  </ContributeContentDesc>
                </ContributeContentLeft>
              ...
              <ContributeContentFlex>
                ...
                <ContributeContentLeft>
                  <ContributeContentDesc>
                    ...
                    guides, overviews, specific tools for using a method, or an
                    example of how you've used a certain method. You can submit
                    a resource recommendation via the
          ...
          <ContributeDiv>
            ...
            <ContributeContentDiv>
              <ContributeContentFlex>
                <ContributeContentLeft>
                  <ContributeContentDesc>
                    What do you think about Practiwiz? We'd love to know how you
                    use it, what you think is useful and what can be improved.
                  </ContributeContentDesc>
                  <ContributeContentDesc>
              ...
              <ContactDivFlex>
                <ContactDivLeft>
                  ...
                  <FormSelect>
                    ...
                    <FormOption>Write blog post</FormOption>
                    <FormOption>Add resource or content</FormOption>
                    <FormOption>Improve content </FormOption>
                    <FormOption>Feedback</FormOption>
                    <FormOption>Found a bug</FormOption>
                  </FormSelect>
                  <TextArea
                    name=""
                    id=""
